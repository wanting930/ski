...
@WebServlet("/ad/slideAd")
public class Sliderad extends HttpServlet{
	private static final long serialVersionUID = 1L;
	private CourseAdService service = new CourseAdServiceImpl();
	private ProductAdService serviceP = new ProductAdServiceImpl();
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		System.out.println(serviceP.slider());
		req.setCharacterEncoding("UTF-8");

		
//		resp.getWriter().print(GsonUtils.toJson(serviceP.slider()));
		resp.getWriter().print(GsonUtils.toJson(serviceP.slider()));
