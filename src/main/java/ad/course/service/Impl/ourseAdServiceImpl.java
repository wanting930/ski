...
import ad.course.service.ourseAdService;
...
public class ourseAdServiceImpl implements ourseAdService{
	...
	public List<CourseDTO> courseAdlist() {
		...
		for(CourseAd ad : ads) {
		    ...
		    Course course = courseDao.getCourseByCourseId(courseID); // 假設透過 courseID 查詢相關 Course 資訊的方法為 getCourseByCourseID()
