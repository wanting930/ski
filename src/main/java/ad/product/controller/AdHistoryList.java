...
import ad.product.service.Impl.ProductAdHistoryServiceImpl;
import ad.product.service.Impl.ProductAdServiceImpl;
import core.util.GsonUtils;

@WebServlet("/ad/padHistory")
public class AdHistoryList extends HttpServlet{

	private static final long serialVersionUID = 1L;

	private ProductAdHistoryService service = new ProductAdHistoryServiceImpl();
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		resp.getWriter().print(GsonUtils.toJson(service.historyList()));
