...
@WebServlet("/member/getOneMember") // http://localhost:8080/ski/member/getOneMember
public class GetOneMemberServlet extends HttpServlet {
	private static final long serialVersionUID = -1727956955567056652L;
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		member = service.findOne(member.getUserID());
