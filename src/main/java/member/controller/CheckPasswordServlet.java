...
@WebServlet("/member/checkPassword") // http://localhost:8080/ski/member/checkPassword
public class CheckPasswordServlet extends HttpServlet {
	private static final long serialVersionUID = -2025249337274259649L;
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		member = service.checkPassword(member);
